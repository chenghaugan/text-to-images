...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/text-to-images)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/text-to-images
```

A live public deployment of this template is available at [https://text-to-images.templates.workers.dev](https://text-to-images.templates.workers.dev)
